                    ...
                    <div className="h-4/5">
                        ...
                        <div className="flex flex-col items-center space-y-2 px-4">
                            ...
                            <Link href="/subs/abonner">
                                <button className={activePage === 'abonner' ? "navBarButton-bgcolor text-white py-2 px-4 rounded transition-colors duration-300": "navBarButton-hover-bgcolor hover:text-white py-2 px-4 rounded transition-colors duration-300 bg-white text-gray-800"}>S'abonner</button>
                            </Link>
